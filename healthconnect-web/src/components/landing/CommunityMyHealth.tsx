...
export default function CommunityMyHealth(){
  ...
  return <section className="continuity-section">
    <style>{`
      .continuity-section{background:#fff;padding:34px 28px 38px;font-family:'DM Sans',Arial,sans-serif}.continuity-frame{max-width:1280px;height:500px;margin:0 auto;border-radius:22px;overflow:hidden;position:relative;background:radial-gradient(circle at 84% 12%,rgba(45,212,191,.18),transparent 29%),radial-gradient(circle at 14% 82%,rgba(96,165,250,.08),transparent 33%),linear-gradient(135deg,#0A1730 0%,#10253B 56%,#123B43 100%);border:1px solid rgba(94,234,212,.13);box-shadow:0 16px 42px rgba(15,23,42,.11)}.continuity-frame:before{content:'';position:absolute;inset:0;background-image:linear-gradient(rgba(255,255,255,.018) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.018) 1px,transparent 1px);background-size:42px 42px;mask-image:linear-gradient(to left,#000,transparent 78%);pointer-events:none}.continuity-tabs{height:58px;padding:12px 30px 0;display:flex;gap:8px;position:relative;z-index:2}.continuity-tab{position:relative;overflow:hidden;border:1px solid rgba(148,163,184,.18);background:rgba(255,255,255,.045);color:#B6CBDE;border-radius:10px;padding:10px 16px;font-size:12px;font-weight:850;cursor:pointer}.continuity-tab.active{color:#fff;border-color:var(--slide-accent);background:rgba(255,255,255,.09)}.continuity-tab.active:after{content:'';position:absolute;left:0;bottom:0;height:2px;background:var(--slide-accent);animation:continuityProgress 6.8s linear forwards}@keyframes continuityProgress{from{width:0}to{width:100%}}
      .continuity-main{height:386px;display:grid;grid-template-columns:minmax(0,1.04fr) minmax(390px,.96fr);gap:48px;align-items:center;padding:22px 58px 28px;position:relative;z-index:2}.continuity-eyebrow{font-size:10px;font-weight:900;letter-spacing:.18em;color:var(--slide-accent);margin-bottom:11px}.continuity-copy h2{font-family:'Sora','DM Sans',sans-serif;color:#F8FBFF;font-size:clamp(2.35rem,3.35vw,3.55rem);line-height:1.025;letter-spacing:-.045em;margin:0 0 14px;max-width:690px}.continuity-copy>p{font-size:14px;line-height:1.65;color:#C4D7E8;max-width:650px;margin:0 0 18px}.continuity-points{display:grid;gap:8px;margin-bottom:19px}.continuity-point{display:flex;align-items:center;gap:10px;color:#E2EEF7;font-size:11.5px;font-weight:750}.continuity-check{width:24px;height:24px;border-radius:50%;display:grid;place-items:center;background:color-mix(in srgb,var(--slide-accent) 17%,transparent);color:var(--slide-accent);font-size:11px;font-weight:900;flex:0 0 24px}.continuity-actions{display:flex;gap:9px;flex-wrap:wrap}.continuity-primary,.continuity-secondary{border-radius:9px;padding:10px 16px;font-size:11px;font-weight:900;cursor:pointer;text-decoration:none;font-family:inherit}.continuity-primary{border:1px solid var(--slide-accent);background:var(--slide-accent);color:#061225}.continuity-secondary{border:1px solid rgba(255,255,255,.24);background:rgba(255,255,255,.04);color:#fff}
      .continuity-preview{background:rgba(255,255,255,.065);border:1px solid rgba(148,163,184,.2);border-radius:18px;padding:15px;box-shadow:0 20px 55px rgba(0,0,0,.18)}.continuity-preview-head{display:flex;justify-content:space-between;align-items:center;color:#A4BDD3;font-size:10px;font-weight:900;letter-spacing:.11em;margin-bottom:11px}.continuity-live{display:flex;align-items:center;gap:6px;color:#86EFAC}.continuity-live:before{content:'';width:6px;height:6px;border-radius:50%;background:#22C55E;box-shadow:0 0 0 4px rgba(34,197,94,.12)}.community-post{background:linear-gradient(135deg,#FAFCFF 0%,#F4FBFF 100%);border:1px solid #CFE3EF;border-left:4px solid #38BDF8;border-radius:13px;padding:15px;color:#10233C}.community-post small,.health-preview small{display:block;font-size:9px;font-weight:900;letter-spacing:.1em;color:#4B78A6;margin-bottom:8px}.community-post b{font-family:'Sora',sans-serif;display:block;font-size:14.5px;line-height:1.38;margin-bottom:7px;color:#123456}.community-post p{font-size:11px;line-height:1.52;color:#526C84;margin:0}.community-meta{margin-top:10px;font-size:9.5px;font-weight:750;color:#0F766E}.community-list{display:grid;gap:6px;margin-top:8px}.community-row{display:flex;justify-content:space-between;gap:12px;align-items:center;text-decoration:none;border:1px solid rgba(125,211,252,.18);background:linear-gradient(90deg,rgba(56,189,248,.08),rgba(52,211,153,.055));border-radius:9px;padding:9px 11px;color:#E6F2FA}.community-row b{font-size:10.5px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#E0F2FE}.community-row span{font-size:9.5px;font-weight:750;color:#86EFAC;white-space:nowrap}.community-safety{margin-top:8px;border-radius:9px;padding:9px 10px;background:rgba(52,211,153,.1);border:1px solid rgba(52,211,153,.2);color:#C2FBE3;font-size:9.5px;line-height:1.35;font-weight:800}
      .health-preview{background:linear-gradient(135deg,#FAFCFF 0%,#F7FBFF 100%);border:1px solid #D3E2EE;border-radius:13px;padding:16px;color:#10233C}.health-score-row{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px}.health-summary{border-radius:10px;padding:11px;border:1px solid transparent}.health-summary:first-child{background:#EAF4FF;border-color:#D4E8FA}.health-summary:last-child{background:#EAFBF4;border-color:#D2F3E4}.health-summary b{display:block;font-family:'Sora',sans-serif;font-size:17px;margin-bottom:4px}.health-summary:first-child b{color:#0F4C81}.health-summary:last-child b{color:#0F766E}.health-summary span{font-size:9.5px;line-height:1.4;color:#536C84}.health-path{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin:13px 0}.health-step{position:relative;border-radius:9px;padding:10px 7px;text-align:center;min-height:68px;border:1px solid transparent}.health-step:nth-child(1){background:#EAF4FF;border-color:#D8E9FA}.health-step:nth-child(2){background:#F0EEFF;border-color:#E2DDFC}.health-step:nth-child(3){background:#EAFBF4;border-color:#D5F2E5}.health-step:nth-child(4){background:#E9F8FA;border-color:#D2EEF1}.health-step:after{content:'→';position:absolute;right:-7px;top:25px;color:#7C94AA;font-size:10px}.health-step:last-child:after{display:none}.health-step strong{display:block;font-size:10px;margin-bottom:5px}.health-step:nth-child(1) strong{color:#2563EB}.health-step:nth-child(2) strong{color:#7C3AED}.health-step:nth-child(3) strong{color:#0D9488}.health-step:nth-child(4) strong{color:#0891B2}.health-step span{font-size:9px;line-height:1.35;color:#405C75;font-weight:650}.health-ready{border-radius:9px;padding:10px 11px;background:linear-gradient(90deg,#ECFDF5,#EAF7FF);border:1px solid #D4EFE3;color:#0F766E;font-size:10px;line-height:1.35;font-weight:850}.continuity-footer{height:56px;border-top:1px solid rgba(148,163,184,.14);background:rgba(3,16,30,.29);display:flex;align-items:center;justify-content:space-between;padding:0 30px;position:relative;z-index:2}.continuity-dots{display:flex;gap:7px}.continuity-dot{width:30px;height:3px;border:0;padding:0;border-radius:999px;background:rgba(148,163,184,.24);cursor:pointer}.continuity-dot.active{background:var(--slide-accent)}.continuity-auto{display:flex;align-items:center;gap:7px;color:#93AAC0;font-size:9.5px;font-weight:850;letter-spacing:.08em}.continuity-auto:before{content:'';width:6px;height:6px;border-radius:50%;background:#22C55E;box-shadow:0 0 0 3px rgba(34,197,94,.13)}
