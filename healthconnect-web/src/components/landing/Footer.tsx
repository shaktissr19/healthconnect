...
export default function Footer(){
  ...
  return <footer className="hc-footer">
    <style>{`
      .hc-footer{background:#071426;color:#fff;padding:54px 28px 24px;font-family:'DM Sans',Arial,sans-serif}.hc-footer-inner{max-width:1280px;margin:0 auto}.hc-footer-grid{display:grid;grid-template-columns:1.35fr repeat(3,1fr);gap:42px;padding-bottom:38px}.hc-footer-brand{display:flex;align-items:center;gap:10px;margin-bottom:14px}.hc-footer-logo{width:40px;height:40px;border-radius:11px;background:linear-gradient(135deg,#0D9488,#14B8A6);display:grid;place-items:center;font-family:'Sora',sans-serif;font-weight:900}.hc-footer-name{font-family:'Sora',sans-serif;font-size:15px;font-weight:850}.hc-footer-domain{font-size:9px;color:#5EEAD4;margin-top:2px}.hc-footer-desc{font-size:12px;line-height:1.7;color:#A9BDD1;max-width:310px;margin:0 0 17px}.hc-footer-trust{display:flex;gap:6px;flex-wrap:wrap}.hc-footer-trust span{font-size:8.5px;font-weight:800;color:#99F6E4;background:rgba(45,212,191,.06);border:1px solid rgba(45,212,191,.16);border-radius:7px;padding:4px 7px}.hc-footer-col h3{font-size:9px;letter-spacing:.13em;text-transform:uppercase;color:#E5EEF8;margin:3px 0 14px}.hc-footer-links{display:grid;gap:9px}.hc-footer-links a,.hc-footer-links button{color:#9CB1C7;text-decoration:none;font:600 11px 'DM Sans',Arial,sans-serif;transition:.15s;background:none;border:0;padding:0;text-align:left;cursor:pointer}.hc-footer-links a:hover,.hc-footer-links button:hover,.hc-footer-links a:focus-visible,.hc-footer-links button:focus-visible{color:#5EEAD4;outline:none}.hc-footer-bottom{border-top:1px solid rgba(148,163,184,.13);padding-top:18px;display:flex;justify-content:space-between;gap:18px;align-items:center;flex-wrap:wrap}.hc-footer-bottom span{font-size:9.7px;color:#8198B0}.hc-footer-bottom-links{display:flex;gap:15px;flex-wrap:wrap}.hc-footer-bottom-links a{font-size:9px;color:#8EA4BA;text-decoration:none}.hc-footer-bottom-links a:hover,.hc-footer-bottom-links a:focus-visible{color:#5EEAD4;outline:none}
