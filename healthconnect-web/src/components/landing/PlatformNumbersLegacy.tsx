...
export default function PlatformNumbersLegacy({ stats }: { stats: PlatformStats }) {
  ...
  return <section className="pn-section" aria-labelledby="pn-heading">
    <style>{`
      .pn-section{background:#F3F5F7;padding:42px 0 46px;font-family:'DM Sans',Arial,sans-serif;color:#10243C;border-top:1px solid #DDE3E8;border-bottom:1px solid #DDE3E8}.pn-head{max-width:1340px;margin:0 auto;padding:0 36px 18px;display:flex;align-items:end;justify-content:space-between;gap:34px}.pn-kicker{display:flex;align-items:center;gap:8px;margin-bottom:7px;color:#137B73;font-size:12px;font-weight:900;letter-spacing:.15em;text-transform:uppercase}.pn-kicker:before{content:'';width:25px;height:2px;background:#62BDB2}.pn-heading{font-family:'Sora','DM Sans',sans-serif;font-size:clamp(2rem,2.65vw,2.8rem);font-weight:900;color:#0E2A3B;letter-spacing:-.04em;line-height:1.04;margin:0}.pn-head p{font-size:14px;line-height:1.5;color:#536B7A;max-width:390px;margin:0}.pn-stage{padding:0 36px}.pn-cards{display:flex;height:320px;max-width:1440px;margin:0 auto;border-radius:20px;overflow:hidden;border:1px solid #CBD6DE;box-shadow:0 14px 34px rgba(22,48,64,.10);background:#DCE3E8}.pn-card{position:relative;overflow:hidden;cursor:pointer;transition:flex .48s cubic-bezier(.4,0,.2,1);border-right:1px solid rgba(255,255,255,.22);outline:none}.pn-card:last-child{border-right:0}.pn-card.col{flex:1}.pn-card.exp{flex:2.35}.pn-card:focus-visible{box-shadow:inset 0 0 0 4px #fff,inset 0 0 0 7px rgba(37,99,235,.65);z-index:4}.pn-photo{position:absolute;inset:0;background-size:cover;background-position:center;transition:opacity .4s ease;background-color:#D9E1E7}.pn-overlay{position:absolute;inset:0;transition:background .4s ease}.pn-col-txt,.pn-exp-txt{position:absolute;left:0;right:0;bottom:0;color:#fff}.pn-col-txt{padding:19px 17px}.pn-exp-txt{padding:25px 28px;animation:pnIn .35s ease both}@keyframes pnIn{from{opacity:0;transform:translateY(9px)}to{opacity:1;transform:translateY(0)}}.pn-stat{font-family:'Sora',sans-serif;font-size:34px;font-weight:900;line-height:1;letter-spacing:-.04em;margin-bottom:5px}.pn-exp-stat{font-family:'Sora',sans-serif;font-size:46px;font-weight:900;line-height:1;letter-spacing:-.045em;margin-bottom:4px}.pn-label{font-size:14px;font-weight:850}.pn-sub{font-size:11.5px;color:rgba(255,255,255,.84);margin-top:4px;line-height:1.35}.pn-exp-sub{font-size:11px;font-weight:850;letter-spacing:.10em;text-transform:uppercase;color:rgba(255,255,255,.86);margin-bottom:6px}.pn-exp-title{font-family:'Sora',sans-serif;font-size:18px;font-weight:800;margin-bottom:7px}.pn-exp-desc{font-size:13px;line-height:1.48;color:rgba(255,255,255,.94);max-width:410px;margin:0 0 13px}.pn-cta{display:inline-flex;align-items:center;background:#fff;padding:9px 13px;border-radius:8px;font-family:'Sora',sans-serif;font-size:11px;font-weight:800;text-decoration:none;text-transform:uppercase;letter-spacing:.03em;box-shadow:0 6px 15px rgba(15,35,45,.12)}.pn-cta:focus-visible{outline:3px solid #fff;outline-offset:3px}.pn-hint{position:absolute;top:14px;right:14px;background:rgba(255,255,255,.92);border:1px solid rgba(255,255,255,.85);color:#17354A;border-radius:999px;padding:6px 9px;font-size:9.5px;font-weight:900;letter-spacing:.06em;text-transform:uppercase;box-shadow:0 5px 15px rgba(18,44,60,.10)}
      @media(max-width:820px){.pn-head{padding:0 20px 18px;align-items:start;flex-direction:column;gap:8px}.pn-stage{padding:0 20px}.pn-cards{height:auto;flex-direction:column}.pn-card,.pn-card.col,.pn-card.exp{flex:none;min-height:250px;border-right:0;border-bottom:1px solid rgba(255,255,255,.18)}}
      @media(max-width:520px){.pn-section{padding:36px 0 40px}.pn-stage{padding:0 12px}.pn-head{padding:0 16px 16px}.pn-heading{font-size:2.05rem}.pn-exp-txt{padding:21px}.pn-exp-stat{font-size:40px}}
    `}</style>
