...
export default function HealthCommunitiesShowcase(){
  ...
  }),{members:0,posts:0,featured:0}),[communities]);
  ...
  return <section className="hc-community-showcase" id="health-communities-story" aria-labelledby="hc-community-title">
    <style>{`
      .hc-community-showcase{font-family:'DM Sans',Arial,sans-serif;color:#10243C;background:#fff;padding:18px 28px 82px;scroll-margin-top:92px}.hc-community-shell{max-width:1664px;margin:0 auto}.hc-community-canvas{position:relative;min-height:700px;border:1px solid #C8E7E3;border-radius:30px;overflow:hidden;background:linear-gradient(115deg,#F9FCFC 0%,#F5FAFA 47%,#E9F5F4 100%);box-shadow:0 20px 48px rgba(24,69,82,.08)}.hc-community-canvas:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 41% 34%,rgba(255,255,255,.96),rgba(255,255,255,.58) 30%,transparent 52%);pointer-events:none;z-index:1}
      .hc-community-photo-wrap{position:absolute;z-index:0;right:0;top:0;width:60%;height:100%;overflow:hidden;background:linear-gradient(135deg,#DCEFED,#BFDCD9)}.hc-community-photo{position:absolute;right:0;top:50%;width:auto;height:84%;max-width:none;object-fit:contain;object-position:right center;transform:translateY(-50%);display:block}.hc-community-photo-shade{position:absolute;inset:0;background:linear-gradient(90deg,rgba(244,251,250,.98) 0%,rgba(244,251,250,.72) 15%,rgba(244,251,250,.22) 30%,rgba(244,251,250,0) 50%)}
      ...
      .hc-community-stats{position:absolute;z-index:8;left:43.8%;top:38px;width:192px;border-radius:18px;background:rgba(255,255,255,.97);border:1px solid #D1E4E5;box-shadow:0 14px 30px rgba(25,61,80,.12);padding:14px 14px 12px}.hc-community-stats-head{display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:12px;font-weight:900;color:#16354A}.hc-community-count{text-align:center;font-family:'Sora','DM Sans',sans-serif;font-size:38px;font-weight:800;color:#0B2B45;line-height:1;margin:16px 0 2px}.hc-community-count-label{text-align:center;font-size:10.8px;color:#486275;margin-bottom:11px}.hc-community-stat-row{display:grid;grid-template-columns:23px 1fr auto;align-items:center;gap:7px;padding:8px 0;border-top:1px solid #E6EEF0}.hc-community-stat-icon{width:23px;height:23px;border-radius:50%;display:grid;place-items:center;background:#EAF4FF;color:#2563EB}.hc-community-stat-row b{font-size:11.8px;color:#14344A}.hc-community-stat-row small{display:block;font-size:9.6px;color:#617887;margin-top:1px}.hc-community-live{font-size:8.8px;font-weight:900;color:#0B9B8D;background:#E5F7F3;border-radius:999px;padding:3px 6px}.hc-community-explore{display:inline-flex;margin-top:9px;color:#0B8F83;font-size:10.7px;font-weight:900;text-decoration:none}
      .hc-community-badge{position:absolute;z-index:6;display:flex;align-items:center;gap:7px;min-width:150px;max-width:190px;padding:8px 10px;border-radius:15px;background:rgba(255,255,255,.93);border:1px solid rgba(221,232,232,.9);box-shadow:0 9px 22px rgba(22,52,65,.12);text-decoration:none;color:#17354A;backdrop-filter:blur(8px)}.hc-community-badge:nth-of-type(1){right:24%;top:11%}.hc-community-badge:nth-of-type(2){right:2.2%;top:15%}.hc-community-badge:nth-of-type(3){right:2.2%;top:39%}.hc-community-badge:nth-of-type(4){right:4%;top:64%}.hc-community-badge-emoji{width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:#EEF8F6;font-size:17px;flex:0 0 auto}.hc-community-badge b{display:block;font-size:10.8px;line-height:1.25}.hc-community-badge span{display:block;font-size:9.2px;color:#607786;margin-top:2px}.hc-community-badge:hover{transform:translateY(-2px)}
      .hc-community-note-card{position:absolute;z-index:6;left:50.8%;bottom:16%;width:235px;padding:13px 14px;border-radius:16px;background:rgba(255,255,255,.94);border:1px solid rgba(221,232,232,.9);box-shadow:0 12px 28px rgba(22,52,65,.12);color:#17354A}.hc-community-note-card b{display:block;font-size:12px;color:#0B665C}.hc-community-note-card span{display:block;margin-top:5px;font-size:10.8px;line-height:1.42;color:#526B7B}
      .hc-community-joinbar{position:absolute;z-index:7;right:2.2%;bottom:5.8%;width:34%;min-height:82px;border-radius:18px;background:rgba(240,251,249,.95);border:1px solid #D2EAE6;display:grid;grid-template-columns:48px 1fr auto;gap:11px;align-items:center;padding:12px 14px;box-sizing:border-box;box-shadow:0 11px 28px rgba(24,69,82,.11);backdrop-filter:blur(8px)}.hc-community-join-icon{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;background:#DFF6F1;color:#0B9B8D}.hc-community-joinbar span{font-size:10.8px;line-height:1.42;color:#425F70}.hc-community-joinbtn{border:0;border-radius:10px;background:#0B9F97;color:#fff;padding:11px 16px;font-size:11.8px;font-weight:900;cursor:pointer;white-space:nowrap;box-shadow:0 7px 16px rgba(11,159,151,.18)}.hc-community-joinbtn:hover{background:#087F78}
      ...
      @media(max-width:1240px){.hc-community-showcase{padding-left:18px;padding-right:18px}.hc-community-left{width:46%;padding-left:34px}.hc-community-stats{left:42.7%}.hc-community-badge{min-width:140px;max-width:175px}.hc-community-joinbar{width:39%}}
      @media(max-width:980px){.hc-community-canvas{min-height:1060px}.hc-community-photo-wrap{left:0;right:0;top:530px;width:100%;height:530px}.hc-community-photo{position:static;width:100%;height:100%;max-width:100%;object-fit:cover;object-position:center;transform:none}.hc-community-photo-shade{background:linear-gradient(180deg,rgba(244,251,250,.25),rgba(244,251,250,0) 45%)}.hc-community-left{width:auto;padding:40px 28px}.hc-community-features{max-width:none}.hc-community-stats{left:auto;right:28px;top:485px;width:192px}.hc-community-badge:nth-of-type(1){left:28px;right:auto;top:610px}.hc-community-badge:nth-of-type(2){right:28px;top:625px}.hc-community-badge:nth-of-type(3){right:28px;top:770px}.hc-community-badge:nth-of-type(4){left:28px;right:auto;top:795px}.hc-community-note-card{left:28px;bottom:135px}.hc-community-joinbar{right:28px;bottom:32px;width:calc(100% - 56px)}.hc-community-popular-grid{grid-template-columns:1fr 1fr}}
      @media(max-width:680px){.hc-community-showcase{padding:8px 10px 60px}.hc-community-canvas{min-height:1390px;border-radius:22px}.hc-community-left{padding:31px 18px}.hc-community-title{font-size:2.25rem}.hc-community-intro{font-size:15px}.hc-community-features{grid-template-columns:1fr 1fr}.hc-community-feature{min-height:155px;padding:15px}.hc-community-photo-wrap{top:835px;height:555px}.hc-community-stats{right:18px;top:790px;width:184px}.hc-community-badge{min-width:132px;max-width:165px}.hc-community-badge:nth-of-type(1){left:18px;top:940px}.hc-community-badge:nth-of-type(2){right:18px;top:955px}.hc-community-badge:nth-of-type(3){right:18px;top:1090px}.hc-community-badge:nth-of-type(4){left:18px;top:1115px}.hc-community-note-card{left:18px;bottom:145px;width:210px}.hc-community-joinbar{left:18px;right:18px;width:auto;bottom:24px;grid-template-columns:44px 1fr}.hc-community-join-icon{width:42px;height:42px}.hc-community-joinbtn{grid-column:1/-1;width:100%}.hc-community-popular-grid{grid-template-columns:1fr}.hc-community-popular-head{align-items:flex-start}.hc-community-popular-head h3{font-size:19px}}
    ...
    <div className="hc-community-shell">
      <div className="hc-community-canvas">
        ...
        <aside className="hc-community-stats" aria-label="Live Health Communities summary">
          ...
          <div className="hc-community-stat-row"><div className="hc-community-stat-icon"><Icon kind="people" size={14}/></div><div><b>{loading?'—':formatCount(totals.members)}</b><small>Members</small></div><span className="hc-community-live">LIVE</span></div>
          <div className="hc-community-stat-row"><div className="hc-community-stat-icon"><Icon kind="chat" size={14}/></div><div><b>{loading?'—':formatCount(totals.posts)}</b><small>Posts</small></div><span className="hc-community-live">LIVE</span></div>
          <div className="hc-community-stat-row"><div className="hc-community-stat-icon"><Icon kind="shield" size={14}/></div><div><b>{loading?'—':formatCount(totals.featured)}</b><small>Featured</small></div><span className="hc-community-live">LIVE</span></div>
        ...
        <div className="hc-community-joinbar"><div className="hc-community-join-icon"><Icon kind="people" size={22}/></div><span>Be part of a supportive health community today.</span><button type="button" className="hc-community-joinbtn" onClick={()=>router.push('/communities')}>Join a Community</button></div>
      </div>
