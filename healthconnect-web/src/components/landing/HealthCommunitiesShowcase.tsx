...
export default function HealthCommunitiesShowcase(){
  ...
  return <section className="hc-community-showcase" id="health-communities-story" aria-labelledby="hc-community-title">
    <style>{`
      ...
      .hc-community-overview{margin-top:18px;padding:17px 18px 18px;border-radius:20px;background:linear-gradient(135deg,#D0DEDA 0%,#D5E0E5 100%);border:1px solid #B4C7C3;box-shadow:0 13px 28px rgba(28,50,64,.09)}.hc-community-overview-head{display:flex;align-items:center;justify-content:space-between;gap:16px}.hc-community-overview-title{display:flex;align-items:center;gap:9px}.hc-community-overview-title h3{font-family:'Sora','DM Sans',sans-serif;font-size:17px;color:#17364D;margin:0}.hc-community-overview-title p{font-size:10.8px;color:#526B7A;margin:3px 0 0}.hc-community-overview-link{flex:0 0 auto;text-decoration:none;background:#244B61;color:#fff;border-radius:9px;padding:8px 11px;font-size:11px;font-weight:900;box-shadow:0 7px 16px rgba(36,75,97,.15)}
      .hc-community-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:14px}.hc-community-metric{min-height:66px;border-radius:13px;padding:11px 13px;background:#EEF3F1;border:1px solid #B8CBC6}.hc-community-metric strong{display:block;font-family:'Sora','DM Sans',sans-serif;font-size:21px;line-height:1;color:#17364D}.hc-community-metric span{display:block;margin-top:5px;font-size:10.7px;color:#536B79}.hc-community-overview-rule{height:1px;background:#B8C9C6;margin:14px 0 12px}.hc-community-popular-label{font-size:10.5px;font-weight:900;letter-spacing:.12em;text-transform:uppercase;color:#6D5B52;margin-bottom:9px}.hc-community-popular-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.hc-community-popular-card{position:relative;display:flex;align-items:center;gap:10px;padding:12px 13px;border-radius:13px;text-decoration:none;color:#17364D;border:1px solid #C7D0CC;background:#F6F4EF;transition:transform .17s ease,box-shadow .17s ease,border-color .17s ease}.hc-community-popular-card:before{content:'';position:absolute;left:0;top:9px;bottom:9px;width:3px;border-radius:3px;background:var(--community-accent)}.hc-community-popular-card:hover{transform:translateY(-2px);border-color:#AEBFBA;box-shadow:0 9px 20px rgba(28,50,64,.09)}.hc-community-popular-card i{font-style:normal;width:34px;height:34px;border-radius:10px;background:#fff;display:grid;place-items:center;font-size:16px;margin-left:3px;box-shadow:inset 0 0 0 1px rgba(23,54,77,.05)}.hc-community-popular-card b{display:block;font-size:12px;color:#17364D}.hc-community-popular-card small{display:block;margin-top:2px;color:#526B7A;font-size:10px}.hc-community-empty{font-size:10.8px;color:#526B7A;padding:12px;border:1px dashed #AEBFC6;border-radius:10px;background:#EEF3F1}
      @media(max-width:1050px){.hc-community-head{grid-template-columns:1fr;gap:8px}.hc-community-stage{min-height:0;padding-top:405px}.hc-community-visual{top:0;left:0;right:0;width:100%;height:405px}.hc-community-visual:before{left:0;right:0;top:auto;width:100%;height:30%;bottom:0;background:linear-gradient(180deg,transparent,#F3EEE7)}.hc-community-content{width:100%;padding:28px}.hc-community-popular-grid{grid-template-columns:1fr 1fr}}
      @media(max-width:650px){.hc-community-showcase{padding:36px 12px 40px}.hc-community-title{font-size:2rem}.hc-community-head p{font-size:14.5px}.hc-community-stage{padding-top:330px}.hc-community-visual{height:330px}.hc-community-content{padding:24px 19px}.hc-community-feature-grid{grid-template-columns:1fr}.hc-community-overview{padding:15px 13px}.hc-community-overview-head{align-items:flex-start}.hc-community-overview-title p{display:none}.hc-community-metrics{grid-template-columns:1fr}.hc-community-popular-grid{grid-template-columns:1fr}.hc-community-visual-label{font-size:8px}.hc-community-visual-label.peer{left:25%}.hc-community-visual-label.women{left:auto;right:4%;top:16%}.hc-community-visual-label.heart{top:48%}}
    `}</style>
    ...
    <div className="hc-community-shell">
      ...
      <div className="hc-community-overview" aria-label="Health Communities activity and popular communities">
        <div className="hc-community-overview-head">
          <div className="hc-community-overview-title"><div><h3>Communities at a glance</h3><p>Live activity and popular spaces, together in one view.</p></div><InfoPopover ariaLabel="About Health Communities statistics" title="About these numbers" width={220}>Community counts and activity come from the current HealthConnect community directory when available. They change as communities, memberships and posts change. Peer support does not replace professional medical advice.</InfoPopover></div>
          <Link href="/communities" className="hc-community-overview-link">View all communities</Link>
        </div>

        <div className="hc-community-metrics">
        ...
        <div className="hc-community-overview-rule"/>
        <div className="hc-community-popular-label">Popular communities</div>
