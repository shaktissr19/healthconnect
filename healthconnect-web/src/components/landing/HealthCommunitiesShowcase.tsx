...
const POPULAR_TINTS=['#F2E0E6','#DDE8F1','#E8E1EF','#DFE9E0'] as const;
...
export default function HealthCommunitiesShowcase(){
  ...
  return <section className="hc-community-showcase" id="health-communities-story" aria-labelledby="hc-community-title">
    <style>{`
      ...
      .hc-community-statsbar{display:grid;grid-template-columns:auto repeat(3,1fr) auto;align-items:center;margin-top:16px;border:1px solid #2F4B60;border-radius:14px;background:#203A4D;overflow:visible;position:relative;z-index:20;box-shadow:0 8px 18px rgba(24,52,75,.11)}.hc-community-statslabel{padding:12px 15px;font-size:11px;font-weight:900;letter-spacing:.11em;text-transform:uppercase;color:#EAF1F4;display:flex;align-items:center;gap:7px}.hc-community-stat{padding:11px 15px;border-left:1px solid #3B5669}.hc-community-stat strong{font-family:'Sora','DM Sans',sans-serif;font-size:19px;color:#fff}.hc-community-stat span{display:block;margin-top:2px;font-size:10.5px;color:#C9D7DF}.hc-community-view{padding:10px 14px;border-left:1px solid #3B5669;color:#E8D8B7;font-size:11.4px;font-weight:900;text-decoration:none;white-space:nowrap}
      .hc-community-popular{margin-top:24px;padding:0 4px;background:transparent;border:0;box-shadow:none}.hc-community-popular-head{display:flex;justify-content:space-between;align-items:center;gap:14px}.hc-community-popular-head h3{font-family:'Sora','DM Sans',sans-serif;font-size:18px;color:#17364D;margin:0}.hc-community-popular-head a{font-size:11.4px;font-weight:900;color:#17364D;text-decoration:none;background:#E8D8B7;border:1px solid #D1BE98;border-radius:8px;padding:7px 10px}.hc-community-popular-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:11px;margin-top:11px}.hc-community-popular-card{position:relative;display:flex;align-items:center;gap:10px;padding:13px;border-radius:13px;text-decoration:none;color:#17364D;border:1px solid color-mix(in srgb,var(--community-accent) 30%,#C8D2D6);background:var(--community-tint);transition:transform .17s ease,box-shadow .17s ease}.hc-community-popular-card:before{content:'';position:absolute;left:0;top:10px;bottom:10px;width:3px;border-radius:3px;background:var(--community-accent)}.hc-community-popular-card:hover{transform:translateY(-2px);box-shadow:0 10px 22px rgba(28,50,64,.10)}.hc-community-popular-card i{font-style:normal;width:34px;height:34px;border-radius:10px;background:rgba(255,255,255,.62);display:grid;place-items:center;font-size:16px;margin-left:3px}.hc-community-popular-card b{display:block;font-size:12.1px;color:#17364D}.hc-community-popular-card small{display:block;margin-top:2px;color:#4E6676;font-size:10.1px}.hc-community-empty{font-size:10.8px;color:#526B7A;padding:12px;border:1px dashed #AEBFC6;border-radius:10px;background:#EDF1EF}
