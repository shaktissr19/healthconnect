...
export default function LandingHero(){
  ...
  return <section className="hc-hero" aria-label="HealthConnect India">
    <style>{`
      ...
      .hc-hero-title-wrap{height:154px;display:flex;align-items:flex-start}.hc-hero h1{font-family:'Sora','DM Sans',sans-serif;font-size:clamp(3rem,4.15vw,4.4rem);line-height:1.02;letter-spacing:-.052em;color:#0A315B;margin:0;max-width:640px;animation:hcHeadlineIn .45s ease both}@keyframes hcHeadlineIn{from{opacity:.2;transform:translateY(6px)}to{opacity:1;transform:none}}.hc-hero-line{display:block;white-space:nowrap}
      .hc-hero-copy p{font-size:18px;line-height:1.62;color:#34576C;max-width:590px;margin:22px 0 0}
      ...
      @media(max-width:1120px){.hc-hero-photo{background-position:72% center}.hc-hero-shade{background:linear-gradient(90deg,rgba(246,252,250,.99) 0%,rgba(244,251,249,.96) 40%,rgba(244,251,249,.62) 57%,rgba(244,251,249,.08) 79%)}.hc-hero-copy{width:min(570px,54vw)}.hc-hero h1{font-size:clamp(2.8rem,4.9vw,3.9rem)}}
      @media(max-width:820px){.hc-hero-canvas{min-height:auto;padding-bottom:330px}.hc-hero-photo{top:auto;height:350px;background-position:center 38%;transform:none}.hc-hero-shade{background:linear-gradient(180deg,#F5FBF9 0%,#F5FBF9 52%,rgba(245,251,249,.62) 71%,rgba(245,251,249,0) 100%)}.hc-hero-inner{min-height:auto;padding:48px 26px 40px}.hc-hero-copy{width:100%;max-width:640px}.hc-hero-title-wrap{height:142px}.hc-hero-line{white-space:normal}.hc-hero-copy p{max-width:600px}}
      @media(max-width:560px){.hc-hero{padding-top:72px}.hc-hero-canvas{padding-bottom:270px}.hc-hero-photo{height:290px}.hc-hero-inner{padding:40px 18px 34px}.hc-hero-eyebrow{font-size:11.5px;letter-spacing:.13em}.hc-hero h1{font-size:clamp(2.45rem,11.2vw,3.1rem)}.hc-hero-title-wrap{height:144px}.hc-hero-copy p{font-size:16px}.hc-hero-actions{display:grid;grid-template-columns:1fr 1fr}.hc-hero-btn{padding:0 14px}.hc-hero-trust{gap:12px}.hc-hero-trust span{font-size:12px}}
