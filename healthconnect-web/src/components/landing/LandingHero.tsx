...
export default function LandingHero(){
  ...
  return <section className="hc-hero" aria-label="HealthConnect India">
    <style>{`
      ...
      .hc-hero-photo{position:absolute;inset:0;background-image:url('/images/hero-intro.png');background-size:auto 79%;background-position:calc(100% - 8px) 61%;background-repeat:no-repeat}.hc-hero-shade{position:absolute;inset:0;background:linear-gradient(90deg,rgba(246,252,250,1) 0%,rgba(244,251,249,.98) 27%,rgba(244,251,249,.66) 38%,rgba(244,251,249,.23) 48%,rgba(244,251,249,.05) 58%,rgba(244,251,249,0) 66%)}
      ...
      @media(max-width:1120px){.hc-hero-photo{background-size:auto 74%;background-position:calc(100% + 8px) 62%}.hc-hero-shade{background:linear-gradient(90deg,rgba(246,252,250,1) 0%,rgba(244,251,249,.96) 36%,rgba(244,251,249,.5) 49%,rgba(244,251,249,.08) 66%)}.hc-hero-copy{width:min(570px,54vw)}.hc-hero h1{font-size:clamp(2.7rem,4.7vw,3.75rem)}}
      @media(max-width:820px){.hc-hero-canvas{min-height:auto;padding-bottom:320px}.hc-hero-photo{top:auto;height:340px;background-size:auto 84%;background-position:center bottom}.hc-hero-shade{background:linear-gradient(180deg,#F5FBF9 0%,#F5FBF9 53%,rgba(245,251,249,.52) 72%,rgba(245,251,249,0) 100%)}.hc-hero-inner{min-height:auto;padding:42px 26px 38px}.hc-hero-copy{width:100%;max-width:640px}.hc-hero-title-wrap{height:138px}.hc-hero-line{white-space:normal}.hc-hero-copy p{max-width:600px}}
