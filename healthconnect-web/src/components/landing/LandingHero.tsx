...
import heroChunk1 from './heroImage/chunk1';
import heroChunk2 from './heroImage/chunk2';
import heroChunk3 from './heroImage/chunk3';

const HERO_IMAGE=`data:image/webp;base64,${heroChunk1}${heroChunk2}${heroChunk3}`;
...
export default function LandingHero(){
  ...
  return <section className="hc-hero" aria-label="HealthConnect India">
    <style>{`
      .hc-hero{padding-top:76px;background:#F5FBF9;font-family:'DM Sans',Arial,sans-serif;color:#0C2635}.hc-hero-canvas{position:relative;min-height:560px;overflow:hidden;background:#F5FAFB}
      .hc-hero-photo{position:absolute;inset:0;background-size:auto 100%;background-position:right center;background-repeat:no-repeat}.hc-hero-shade{position:absolute;inset:0;background:linear-gradient(90deg,rgba(247,252,251,.98) 0%,rgba(247,252,251,.94) 25%,rgba(247,252,251,.72) 35%,rgba(247,252,251,.26) 47%,rgba(247,252,251,0) 59%)}
      .hc-hero-inner{position:relative;z-index:2;max-width:1380px;margin:0 auto;padding:52px 44px 46px;min-height:560px;display:flex;align-items:center}.hc-hero-copy{width:min(610px,46vw)}.hc-hero-welcome{font-family:'Sora','DM Sans',sans-serif;font-size:21px;font-weight:750;color:#0A315B;margin-bottom:13px;letter-spacing:-.02em}.hc-hero-eyebrow{display:flex;align-items:center;gap:9px;color:#087F70;font-size:13px;font-weight:900;letter-spacing:.15em;text-transform:uppercase;margin-bottom:18px}.hc-hero-eyebrow:before{content:'';width:18px;height:2px;background:#0D9488;border-radius:2px}
      ...
      @media(max-width:1120px){.hc-hero-photo{background-size:auto 96%;background-position:right center}.hc-hero-shade{background:linear-gradient(90deg,rgba(247,252,251,1) 0%,rgba(247,252,251,.96) 34%,rgba(247,252,251,.64) 46%,rgba(247,252,251,.12) 64%)}.hc-hero-copy{width:min(570px,54vw)}.hc-hero h1{font-size:clamp(2.7rem,4.7vw,3.75rem)}}
      @media(max-width:820px){.hc-hero-canvas{min-height:auto;padding-bottom:330px}.hc-hero-photo{top:auto;height:350px;background-size:auto 100%;background-position:right center}.hc-hero-shade{background:linear-gradient(180deg,#F5FBF9 0%,#F5FBF9 54%,rgba(245,251,249,.72) 68%,rgba(245,251,249,0) 100%)}.hc-hero-inner{min-height:auto;padding:42px 26px 38px}.hc-hero-copy{width:100%;max-width:640px}.hc-hero-title-wrap{height:138px}.hc-hero-line{white-space:normal}.hc-hero-copy p{max-width:600px}}
