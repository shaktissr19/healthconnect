...
export default function LandingHero() {
  ...
  return <section className="lh-shell">
    <style>{`
      ...
      .lh-preview-head{display:flex;justify-content:space-between;align-items:center;color:#B4C7DA;font-size:10.5px;font-weight:900;letter-spacing:.11em;margin-bottom:12px}.lh-live{color:#86EFAC}
