...
export default function CommunityBenefits(){
  ...
  return <section className="doctor-platform-section" id="doctor-platform-story" aria-labelledby="doctor-platform-title">
    <style>{`
      ...
      .doctor-platform-nav{display:flex;align-items:center;gap:14px;margin-top:14px;padding:6px 7px 6px 12px;border:1px solid #B4C7D0;border-radius:14px;background:rgba(222,234,239,.9);box-shadow:0 7px 16px rgba(32,63,81,.07)}.doctor-story-tabs{display:flex;align-items:center;gap:27px;min-width:0;flex:1}.doctor-story-tab{position:relative;border:0;background:transparent;padding:9px 1px 10px;color:#577080;font:850 11px 'DM Sans',Arial,sans-serif;cursor:pointer;transition:color .16s ease}.doctor-story-tab:after{content:'';position:absolute;left:0;right:0;bottom:2px;height:3px;border-radius:999px;background:transparent}.doctor-story-tab:hover{color:#17384A}.doctor-story-tab.active{color:#17384A}.doctor-story-tab.active:after{background:var(--tab-accent)}.doctor-platform-actions{display:flex;align-items:center;gap:8px;margin-left:auto}.doctor-platform-cta{border-radius:9px;padding:10px 14px;font:900 11.5px 'DM Sans',Arial,sans-serif;cursor:pointer;white-space:nowrap;transition:transform .16s ease,background .16s ease,box-shadow .16s ease}.doctor-platform-cta:hover{transform:translateY(-1px)}.doctor-platform-cta.primary{border:1px solid #24495D;background:#24495D;color:#fff;box-shadow:0 7px 16px rgba(36,73,93,.16)}.doctor-platform-cta.primary:hover{background:#1C3E51}
      ...
      @media(max-width:650px){.doctor-platform-section{padding:36px 12px 40px}.doctor-platform-head h2{font-size:2rem}.doctor-platform-head p{font-size:14.5px}.doctor-platform-stage{padding-top:330px}.doctor-platform-visual{height:330px}.doctor-platform-copy{padding:24px 19px}.doctor-platform-copy>h3{font-size:1.75rem}.doctor-platform-nav{display:block;padding:8px 10px 10px}.doctor-story-tabs{gap:15px;overflow-x:auto}.doctor-platform-actions{margin:7px 0 0}.doctor-platform-cta{width:100%}}
    `}</style>
    ...
    <div className="doctor-platform-shell">
      ...
      <div className="doctor-platform-stage">
        ...
        <div className="doctor-platform-copy">
          ...
          <div className="doctor-platform-nav" aria-label="Doctor Platform preview and workspace action">
