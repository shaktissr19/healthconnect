...
export default function CommunityBenefits(){
  ...
  return <section className="doctor-platform-section" id="doctor-platform-story" aria-labelledby="doctor-platform-title">
    <style>{`
      ...
      .doctor-platform-stage{position:relative;min-height:440px;border:1px solid #9FB3BF;border-radius:26px;overflow:hidden;background:linear-gradient(108deg,#EAF0F3 0%,#EAF0F3 47%,#DCE8EC 62%,#C9DCE2 100%);box-shadow:0 18px 40px rgba(30,55,72,.14)}.doctor-platform-visual{position:absolute;z-index:0;right:0;top:0;width:58%;height:100%;overflow:hidden;background:#D8E5EA}.doctor-platform-photo{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 42%;display:block}.doctor-platform-visual:before{content:'';position:absolute;z-index:2;left:-1px;top:0;bottom:0;width:34%;background:linear-gradient(90deg,#EAF0F3 0%,rgba(234,240,243,.9) 35%,rgba(234,240,243,.32) 76%,transparent 100%);pointer-events:none}.doctor-platform-copy{position:relative;z-index:3;width:54%;padding:33px 34px 30px 38px;box-sizing:border-box}.doctor-platform-copy>h3{font-family:'Sora','DM Sans',sans-serif;font-size:clamp(1.72rem,2vw,2.18rem);line-height:1.08;letter-spacing:-.04em;color:#17354A;margin:0 0 7px}.doctor-platform-intro{font-size:13.8px;line-height:1.46;color:#506B7B;margin:0 0 13px;max-width:520px}.doctor-platform-rule{width:42px;height:3px;border-radius:999px;background:#315B69;margin-bottom:14px}
      .doctor-story{padding:17px 17px 16px;border-radius:17px;background:#294B5D;border:1px solid #3B6074;box-shadow:0 12px 26px rgba(21,48,64,.16);animation:doctorStoryIn .32s ease both;color:#fff}@keyframes doctorStoryIn{from{opacity:.25;transform:translateY(4px)}to{opacity:1;transform:none}}.doctor-story-label{display:flex;align-items:center;gap:9px;font-size:10.8px;font-weight:900;letter-spacing:.09em;text-transform:uppercase;color:var(--story-accent);margin-bottom:8px}.doctor-story-icon{width:34px;height:34px;border-radius:10px;display:grid;place-items:center;background:rgba(255,255,255,.1);color:var(--story-accent);border:1px solid rgba(255,255,255,.12)}.doctor-story h4{font-family:'Sora','DM Sans',sans-serif;font-size:20px;line-height:1.22;letter-spacing:-.03em;color:#fff;margin:0 0 7px;max-width:500px}.doctor-story p{font-size:12.6px;line-height:1.48;color:#DCE8ED;margin:0;max-width:500px}.doctor-story-facts{display:flex;gap:7px;flex-wrap:wrap;margin-top:11px}.doctor-story-fact{padding:5px 8px;border-radius:999px;background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.13);font-size:9.7px;font-weight:850;color:#F1F7F8}.doctor-story-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:11px}.doctor-story-tab{border:1px solid #B6C4CC;background:#DDE5E9;border-radius:9px;padding:9px;color:#4F6878;font:850 10.8px 'DM Sans',Arial,sans-serif;cursor:pointer;transition:background .16s,color .16s,border-color .16s,transform .16s}.doctor-story-tab:hover{transform:translateY(-1px);background:#E7EDF0}.doctor-story-tab.active{background:#315B69;border-color:#315B69;color:#fff;box-shadow:inset 0 3px 0 var(--tab-accent)}.doctor-platform-flow{display:grid;grid-template-columns:repeat(3,1fr);gap:0;margin-top:13px;padding-top:12px;border-top:1px solid #C5D1D7}.doctor-flow-step{padding:0 10px;color:#5D7382;font-size:10.4px;line-height:1.38}.doctor-flow-step:first-child{padding-left:0}.doctor-flow-step+.doctor-flow-step{border-left:1px solid #C5D1D7}.doctor-flow-step b{display:block;color:#17354A;font-size:10.8px;margin-bottom:2px}.doctor-platform-actions{display:flex;align-items:center;gap:9px;flex-wrap:wrap;margin-top:15px}.doctor-platform-cta{border-radius:10px;padding:10px 15px;font:900 11.8px 'DM Sans',Arial,sans-serif;cursor:pointer;transition:transform .16s ease,background .16s ease}.doctor-platform-cta:hover{transform:translateY(-1px)}.doctor-platform-cta.primary{border:1px solid #24495D;background:#24495D;color:#fff;box-shadow:0 8px 18px rgba(36,73,93,.18)}.doctor-platform-cta.primary:hover{background:#1C3E51}.doctor-platform-cta.secondary{border:1px solid #9EB1BD;background:#E7EDF1;color:#24495D}.doctor-platform-cta.secondary:hover{background:#F2F6F8}.doctor-platform-note{font-size:10.6px;color:#5A7180;font-weight:800;margin-left:2px}
