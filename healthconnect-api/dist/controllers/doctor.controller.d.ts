...
export declare function searchPatients(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function sendAccessRequest(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function getAccessRequests(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
